...
class CloseRKB extends StatefulWidget {
  const CloseRKB({Key? key}) : super(key: key);

  @override
  State<CloseRKB> createState() => _CloseRKBState();
}

class _CloseRKBState extends State<CloseRKB> {
